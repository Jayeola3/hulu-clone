	...
	return (
		...
		<div className="flex flex-col items-center sm:flex-row sm:justify-between m-5 h-auto">
			<div className="flex flex-grow justify-evenly max-w-2xl">
			 ...
			 <form onSubmit = {SearchMovie} className="flex border-2 px-3 w-500 max-w-md sm:w-48 rounded-lg sm:-mt-3 mb-4 mx-8 ">
				<input
					onChange={changeHandler }
					value={query}
					placeholder = "Search a movie"
					type="text"
					className=" bg-transparent appearance-none rounded w-280 leading-tight focus:outline-none focus:shadow-outline"
				/>
				<SearchIcon
					onClick={SearchMovie}
