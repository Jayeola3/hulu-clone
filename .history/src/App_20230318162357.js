			...
			<div className="flex flex-grow justify-evenly max-w-2xl">
			 ...
			 <form onSubmit = {SearchMovie} className="flex border-2 px-3 w-full max-w-md sm:w-48 rounded-lg sm:-mt-3 mb-4 mx-8 ">
				<input
					...
					type="text"
					className=" bg-transparent appearance-none rounded w-full lg:w-40 leading-tight focus:outline-none focus:shadow-outline"
				/>
				<SearchIcon
					onClick={SearchMovie}
					 className=" h-120 cursor-pointer hover:text-white hover:shadow-md"
				/>
			</form> 
