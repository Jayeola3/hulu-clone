...
const Main = ({title,poster_path,vote_average,release_date,overview}) => {
    ...
    return (
        ...
        <div className="flex flex-wrap justify-center"> 
			 ...
			 <button className="bg-[#fff]  text-[#06202A] font-bold py-2 px-4 rounded-full" onClick={handleOpenModal}>View More</button><br></br>
			 </div>
             ...
             <div >
				...
				<h3>{title}</h3>
                    ...
                    <p>{overview}</p>
					<button className="bg-[#fff]  text-[#06202A] font-bold py-2 px-4 rounded-full" onClick={handleClose}>Close</button>
